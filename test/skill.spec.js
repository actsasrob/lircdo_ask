...
//import {handler as skillHandler} from '../lambda/custom/index';
//const alexaTest = require('ask-sdk-test');
const AlexaTest = require('./node_modules/ask-sdk-test/dist/index.js');
const LaunchRequestBuilder = require('./node_modules/ask-sdk-test/dist/factory/LaunchRequestBuilder.js');
const skillHandler = require('../lambda/custom/index.js');

// initialize the testing framework
const skillSettings = {
   appId: "amzn1.ask.skill.1640f539-4c65-43e2-8523-62478f40d2ba", 
   userId: "amzn1.ask.account.AEFTLT7DQAY3LSK3ACZAWKQMYXUFCVH5IOUJ4BW3JKMZK6POOK5SNCEIECL6PCUGB22RMX7KWVDM7OLB3TMXAC37QKOOICXXLYLLZKECPHW4XPQ4NRDXQXC5DAQUZK7GJSVOIZ2AIMEWDPLXVREHUWU2F3RVRP4HZWOKOUWGXOTR6WQE4FIWZ6CTYMYCXO3IAJ73VTDC3VZQMDI",
   deviceId: "amzn1.ask.device.AERQWYDPXKPVES7MTBLCVLG6R2XHGFK6TKY7B5MLQD2PXZIQ74CGJBMXSNWJYECJORZNITQN62KJECR7MAAXRM5OQVLJI33ZRSCJMHC7O4U3ESRXWDRPV5H6V67NKJNQQX75X3SKRLRKMYL575G2FA3UY5TRYEN3B36HWJTBAOWVDKH3XYI2S",
   locale: 'en-US',
   };

		//const alexaTest1 = new AlexaTest(skillHandler, skillSettings);
...
//        "amzn1.ask.device.AERQWYDPXKPVES7MTBLCVLG6R2XHGFK6TKY7B5MLQD2PXZIQ74CGJBMXSNWJYECJORZNITQN62KJECR7MAAXRM5OQVLJI33ZRSCJMHC7O4U3ESRXWDRPV5H6V67NKJNQQX75X3SKRLRKMYL575G2FA3UY5TRYEN3B36HWJTBAOWVDKH3XYI2S");
//alexaTest.setDynamoDBTable('lircdo_test_tbl');

const alexaTest = new AlexaTest.AlexaTest(require('../lambda/custom/index.js'), skillSettings);
...
describe("Lirc Do Skill", function () {
	...
	describe("LaunchRequest", function () {
		...
		alexaTest.test([
			{
                                request: new LaunchRequestBuilder.LaunchRequestBuilder(skillSettings).build(),
